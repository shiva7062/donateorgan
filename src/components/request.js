...
function Request() {
  ...
  function add() {
    ...
    var a = alert("Request Submitted  We Will Contact Shortly");
    }
           ...
           <center><legend>Personal Details</legend></center>
            ...
            <Container>
                <Row>
                    ...
                    <label className='from-label'>Doctor Prescription<span className="text-danger">*</span><input type="file" /></label>
                    </Col>
                    <Col className='col-md-6'>
                    <label>Medical Reports <span className="text-danger">*</span><input type="file" required/></label>
                    </Col>
                </Row>
                <Row>
                    <Col>
                    <label htmlFor="organ">Organ Need:<span className="text-danger">*</span></label>
                    ...
                    <Col>
                    <label htmlFor="blood">Your Blood Group:<span className="text-danger">*</span></label>
                    <select name="st" id="state" required>
                ...
                <Row>
                    ...
                    <center><button style={{width: "60px"}} onClick={() => add()}>Submit</button></center>
                    </Col>
                </Row>
      </fieldset>
      </form>
